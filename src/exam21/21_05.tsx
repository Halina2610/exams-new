...
const Modal = (props: any) => {
    ...
    return (
        <div style={modalContent}>
            ...
            <input defaultValue={value}  onChange={(e) => setValue(e.currentTarget.value)} />
...
//
// 🖥 Пример ответа: defaultValue={value} не верно <input defaultValue={value}  onChange={(e) => setValue(e.currentTarget.value)} />
// наверное   <input value={props.value} onChange={(e) => props.setValue(e.target.value)} />