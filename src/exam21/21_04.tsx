...
const appReducer22 = (state: InitStateType = initState, action: ActionsType): InitStateType => {
    switch (action.type) {
        case "LIKE":
            return {
                ...state,
            ...
            return {
                ...
                animals: state.animals.map((animal) => {
                    if (animal.name === action.name) {
                        return { ...animal, likes: action.likes };
                    }
                    return animal;
                }),
            };
...
//
// 🖥 Пример ответа: -{a.likes + 1}- не верно  if (animal.name === action.name) {
//                         return { ...animal, likes: action.likes };
//                     }
//                     return animal;
